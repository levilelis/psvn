  ...
  //      printf( "\n" );
        ...
        if ( d == INT_MAX ) {
            printf( "no solution found. expanded nodes: %" PRId64 ", generated nodes: %" PRId64 "\n",
            		nodes_expanded_for_bound, nodes_generated_for_bound );
        } else {
            printf( "cost: %d, expanded: %" PRId64 ", nodes: %" PRId64 "\n",
		      d, nodes_expanded_for_bound, nodes_generated_for_bound );
        }
        total_d += d;
        total_expanded  += nodes_expanded_for_bound;
        total_generated += nodes_generated_for_bound;
