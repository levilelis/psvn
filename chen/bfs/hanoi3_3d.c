...
static const char *name_of_domain[ NUMDOMAINS ] = { "N3" };
static int var_domains[ NUMVARS ] = { 0, 0, 0 };
static const char *domain_0[ 3 ] = {"1", "2", "3" };
static const char **domain_to_domain_names[ NUMDOMAINS ] = { domain_0 };
static const char **var_domain_names[ NUMVARS ] = { domain_0, domain_0, domain_0 };
...
static const char *fwd_rule_names[ 18 ] = { "DISK1_FROM1_TO2", "DISK1_FROM1_TO3", "DISK1_FROM2_TO1", "DISK1_FROM2_TO3", "DISK1_FROM3_TO1", "DISK1_FROM3_TO2", "DISK2_FROM1_TO2", "DISK2_FROM1_TO3", "DISK2_FROM2_TO1", "DISK2_FROM2_TO3", "DISK2_FROM3_TO1", "DISK2_FROM3_TO2", "DISK3_FROM1_TO2", "DISK3_FROM1_TO3", "DISK3_FROM2_TO1", "DISK3_FROM2_TO3", "DISK3_FROM3_TO1", "DISK3_FROM3_TO2" };
static const char *bwd_rule_names[ 18 ] = { "DISK1_FROM1_TO2", "DISK1_FROM1_TO3", "DISK1_FROM2_TO1", "DISK1_FROM2_TO3", "DISK1_FROM3_TO1", "DISK1_FROM3_TO2", "DISK2_FROM1_TO2", "DISK2_FROM1_TO3", "DISK2_FROM2_TO1", "DISK2_FROM2_TO3", "DISK2_FROM3_TO1", "DISK2_FROM3_TO2", "DISK3_FROM1_TO2", "DISK3_FROM1_TO3", "DISK3_FROM2_TO1", "DISK3_FROM2_TO3", "DISK3_FROM3_TO1", "DISK3_FROM3_TO2" };
...
static int fwd_rule_label_sets[54] = {0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2};

static int bwd_rule_label_sets[54] = {0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2};
...
{
  child_state->vars[ 0 ] = abst->project_away_var[ 0 ] ? 0 : abst->value_map[0][2];
  child_state->vars[ 1 ] = state->vars[ 1 ];
  child_state->vars[ 2 ] = state->vars[ 2 ];
}
...
{
  child_state->vars[ 0 ] = abst->project_away_var[ 0 ] ? 0 : abst->value_map[0][1];
  child_state->vars[ 1 ] = abst->project_away_var[ 1 ] ? 0 : abst->value_map[0][2];
  child_state->vars[ 2 ] = state->vars[ 2 ];
}
...
static void dynfwdrule14( const state_t *state, state_t *child_state, const abstraction_t* abst )
{
  child_state->vars[ 0 ] = abst->project_away_var[ 0 ] ? 0 : abst->value_map[0][1];
  child_state->vars[ 1 ] = abst->project_away_var[ 1 ] ? 0 : abst->value_map[0][1];
  child_state->vars[ 2 ] = abst->project_away_var[ 2 ] ? 0 : abst->value_map[0][2];
}
...
static int fwdfn0( const state_t *state, void *next_func )
{
  ...
  case 0:
    *((func_ptr *)next_func) = fwdfn0_a0_1;
    return 0;
  case 1:
    *((func_ptr *)next_func) = fwdfn0_a1_1;
    return 2;
  default:
    *((func_ptr *)next_func) = fwdfn0_a2_1;
    return 4;
  }
}
...
static const int fwd_var_test_table_data[] = {25,3,32705,28,0,19,21,23,3,32705,28,0,2,9,10,3,32705,28,0,-1,7,8,3,32705,28,0,13,4,14,3,32705,28,0,11,-1,12,3,32705,28,0,17,18,6,3,32705,28,0,15,16,-1,0,15,-1,-1,0,17,-1,-1,0,9,-1,-1,0,11,-1,-1,0,13,-1,-1,0,16,-1,-1,0,7,-1,-1,0,10,-1,-1,0,12,-1,-1,0,14,-1,-1,0,6,-1,-1,0,8,-1,-1,0,0,20,-1,0,1,1,-1,0,2,22,-1,0,3,3,-1,0,4,24,-1,0,5,5,-1};
...
static int bwdfn0( const state_t *state, void *next_func )
{
  ...
  case 0:
    *((func_ptr *)next_func) = bwdfn0_a0_1;
    return 2;
  case 1:
    *((func_ptr *)next_func) = bwdfn0_a1_1;
    return 0;
  default:
    *((func_ptr *)next_func) = bwdfn0_a2_1;
    return 1;
  }
}
...
static const int bwd_var_test_table_data[] = {25,3,32705,28,0,19,21,23,3,32705,28,0,2,9,10,3,32705,28,0,-1,7,8,3,32705,28,0,13,4,14,3,32705,28,0,11,-1,12,3,32705,28,0,17,18,6,3,32705,28,0,15,16,-1,0,17,-1,-1,0,15,-1,-1,0,11,-1,-1,0,9,-1,-1,0,16,-1,-1,0,13,-1,-1,0,10,-1,-1,0,7,-1,-1,0,14,-1,-1,0,12,-1,-1,0,8,-1,-1,0,6,-1,-1,0,2,20,-1,0,4,1,-1,0,0,22,-1,0,5,3,-1,0,1,24,-1,0,3,5,-1};
...
{
  if( state->vars[ 0 ] == 0 && state->vars[ 1 ] == 0 && state->vars[ 2 ] == 0 ) {
    return 1;
  }
  return 0;
}
...
const compiled_game_so_t hanoi3_3d = {
  NUMVARS,
  sizeof( var_t ),
  sizeof( state_t ),
